...
//硬件尺寸
//#define LA (65.45) //R:A轴的长度91.08- 22.60 - 2.95
#define LA (65.33) //B:A轴的长度91.42- 23.14 - 2.95
...
//#define DIFFHEIGHT  (22.680) //R:棋盘面和机械底面的高度差
#define DIFFHEIGHT  (23.140) //B:棋盘面和机械底面的高度差
#define LineWidth	   (1.0000)  //线宽
//#define DISBOUNDARY    (141.5)  //R:棋盘底部边界到中轴的最短距离126.5 + 15.0
#define DISBOUNDARY    (140.5)  //B:棋盘底部边界到中轴的最短距离126.5 + 14.0
